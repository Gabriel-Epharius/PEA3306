...
V1CP = V2Linha+ Ialta(0.6 - j*sin(acos(0.6)) )*Zcc*(cos(faseZcc)+j*sin(faseZcc)) 


V1 = V2Linha+ Ialta*Zcc*(cos(faseZcc)+j*sin(faseZcc)) 
...
RendimentoCargaPlena = rendimentosFPCapacitivo(8)
...
RegulacaoCargaPlena = regulacoesFPCapacitivo(8)
